        ...
        if (legaltable.getSelectedRow() >= 0) {
            ...
            for (int i = 0; i < ecosystem.getHospitalManagerDirectory().getHospitalManagerList().size(); i++) {
                if(ecosystem.getHospitalManagerDirectory().getHospitalManagerList().get(i).getNetwork().equals(cust.getNetwork())){
                    ...
                    if(j == legaltable.getSelectedRow()){
                        key = i;
            ...
            System.out.println(cust.getNetwork());
            CustomerSelectHospitalManagerPanel mm = new CustomerSelectHospitalManagerPanel(userProcessContainer, this.userAccount, ecosystem,  ecosystem.getHospitalManagerDirectory().getHospitalManagerList().get(key), screen);

...
public void viewMaidList() {
    ...
    if (ecosystem.getMaidDirectory().getMaidList() != null && 
        ecosystem.getMaidDirectory().getMaidList().size() > 0) {
        
        for (Maid maid : ecosystem.getMaidDirectory().getMaidList()) {
            model.addRow(new Object[]{
                maid.getName(),
                maid.getManagerDetails() != null ? maid.getManagerDetails().getName() : "N/A",
                maid.getLocation(),
                maid.getPhone(),
                maid.getNetwork()
            });
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/mmmmmmmmm.jpg"))); // NOI18N

...
public class CustomerOrderMaidPanel extends javax.swing.JPanel {
   ...
   public void populateRequestTable() {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("<html><h1>Need a Break? We are here!</h1> <p><h2>Dont worry about your houshold chores, we got you! <br> BOOK us for an hour, day or months.</p></h2> <br> <b><p><h2>We provide all kinds of househelp in a few clicks.</p></h2></html>");

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cleaningservice.gif"))); // NOI18N

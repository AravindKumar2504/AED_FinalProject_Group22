...
public class OrderGroceryPanel extends javax.swing.JPanel {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 370, 440, 340));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 13)); // NOI18N
        jLabel3.setText("<html>   <h2>Ready to whip up something delicious?<br> No worries—browse our top-rated stores for all your ingredients.<br> Not in the mood to cook? Just hit the restaurant button and enjoy a great meal!</h2> </html> ");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 430, -1, -1));
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 460, 210, 191));
